...
abstract class PluralRules
{
    ...
    static int attrForQuantity(final int quantity)
    {
    ...
    static String stringForQuantity(final int quantity)
    {
        switch (quantity) {
            case QUANTITY_ZERO:
                return "zero";
    ...
    private final static Map<String, PluralRules> allRules = new HashMap<>();
    ...
    static
    {
        ...
        addRules( new String [] {"hr", "sr", "uk", "be", "bs", "sh"}, new PluralRules_Balkan());
        ...
        addRules( new String [] {"ru"}, new PluralRules_Russian());
    ...
    private static void addRules(final String[] languages, final PluralRules rules)
    {
    ...
    static PluralRules ruleForLocale(final Locale locale)
    {
